...
<html lang="en">
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-174475964-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'UA-174475964-1');
    </script> 
    <!-- Global site tag (gtag.js) - Google Analytics -->
  </head>
        ...
        <div class="row" data-aos="fade-left">
          <div class="col-lg-11">
            <h1><span class="typed-words"></span></h1>
              <p>Our mission is to provide you the best solutions that suit your needs perfectly.</p>
          </div>   
        </div>
      </div>  
    </div>
...
<section class="site-section" id="about-section" data-aos="fade">
  <div class="container">
    <!--<h2 class="mission-title"></h2>-->
      <div class="row about">
        ...
        <div class="col-12">
            <p>
              Our web development services delivers on this mission by providing full-cycle project 
              management services. 
            </p>
            <p>Besides, we strive to enhance your business when you are short-handed : We can 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-12">
             <div class="process">
                <div class="bx">
                  <h3>Plan <i class="fa fa-angle-down accordin" data-toggle="#plan" ></i></h3>
                  <div id="plan" class="procdiv">
                    <p>We’ll help you to validate your ideas, create prototypes, develop a roadmap and implement your vision, through deep-dive business and user analysis. </p>
                  </div>
                </div>

                <div class="bx">
                  <h3>Design <i class="fa fa-angle-down accordin" data-toggle="#design" ></i></h3>
                  <div id="design" class="procdiv">
                    <p>Our team designs simple, unique, innovative, and award-winning solutions that allow us to attract clients in the market. Our product design services let you prototype, test, and validate your ideas and get your product to market faster. </p>
                  </div>
                </div>

                <div class="bx">
                  <h3>Development <i class="fa fa-angle-down accordin" data-toggle="#development" ></i></h3>
                  <div id="development" class="procdiv">
                    <p>Our web development services includes everything from a simple CMS enabled website to developing powerful progressive websites, such as custom startup websites, e-commerce websites, and etc. </p>
                  </div>
                </div>

                <div class="bx">
                  <h3>Responsive <i class="fa fa-angle-down accordin" data-toggle="#responsive" ></i></h3>
                  <div id="responsive" class="procdiv">
                    <p>Our team works on each and every section of the website so that your website fits in any device. We redefine, reposition, improve, and grow existing products. </p>
                  </div>
                </div>


                <div class="bx">
                  <h3>Final test <i class="fa fa-angle-down accordin" data-toggle="#test" ></i> </h3>
                  <div id="test" class="procdiv">
                    <p>We help every customer to prepare for market launch and larger businesses, startups to test out their boldest ideas. Through analysis of your business goals, market trends, and technological possibilities, we serve you services and technology-proved concepts that best fit your needs. </p>
                  </div>
                </div>

                <div class="bx">
                  <h3>Launch <i class="fa fa-angle-down accordin" data-toggle="#launch" ></i></h3>
                  <div id="launch" class="procdiv">
                    <p>'WEBNODITES' expert product team lives and breathes your concept – gaining insights from key stakeholders and the market at large, so you can develop your idea with confidence. </p>
                  </div>
                </div>
          ...
          <div class="col-md-5 col-12">
            <div class="imgbox">
              <img src="images/prbg.jpg" alt="web">
            </div>
          </div>
    ...
    <section class="site-section" id="gallery-section">
      <div class="container">
         <div class="col-12 mb-3 hd">
            <h3 class="text-head ">Some Of Our Latest Work</h3>
        </div>
    ...
    <section class="site-section" id="testimonials-section" data-aos="fade">
      <div class="container">
        <h3 class="testmh1 mb-2">Testimonial</h3>
        <h2 class="testmh2 mb-2">Our customers love us</h2>
          ...
          <div class="owl-carousel owl-style owl-carousel-one no-owl-nav">
            ...
            <div>
              <div class="block-testimony-1 ">
                <div class="f">
                  <figure>
                  <img src="images/person_1.jpg" alt="testimony1" class="img-fluid" >
                  </figure>
                ...
                <div class="l">
                  <p>&ldquo;Easy access and awesome to use this 
                      website to start my small business.&rdquo;</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div class="block-testimony-1 ">
                <div class="f">
                  <figure>
                  <img src="images/person_1.jpg" alt="testimony2" class="img-fluid">
                  </figure>
            ...
            <div>
              <div class="block-testimony-1 ">
                <div class="f">
                  <figure>
                  <img src="images/person_1.jpg" alt="testimony3" class="img-fluid">
                  </figure>
