!(function (t, e) {
  ...
  return (function (t) {
    ...
    1: function (t, e, i) {
      ...
      (r.register = (t, e) => (r[t] = (t) => new e(t))), (r.version = "0.5.15");
      const h = function () {
        return (
      ...
      (r.VantaBase = class {
        ...
        windowMouseMoveWrapper(t) {
          ...
          s >= 0 &&
            ...
            ((this.mouseX = s),
            (this.mouseY = o),
            this.options.mouseEase || this.triggerMouseMove(s, o));
        }
    ...
    13: function (t, e, i) {
      ...
      class r extends s.b {
        ...
        material(t) {
          return new n.MeshLambertMaterial({ color: t });
        }
        genRing(t, e, i, s, r, h, a) {
          null == s && (s = 0),
            null == r && (r = 1.4 * Math.PI),
            null == h && (h = 0),
            null == a && (a = 1),
          ...
          const c = {
              ...
              bevelEnabled: !1,
              steps: 1,
              curveSegments: ~~((64 * r) / 6.14)
            },
            u = new n.Shape();
          u.absarc(0, 0, e + i, 0, r, !1),
            u.lineTo(e * Math.cos(r), e * Math.sin(r)),
            u.absarc(0, 0, e, r, 0, !0);
          const l = new n.ExtrudeGeometry(u, c),
            d = this.material(t);
          (0 === Object(o.g)(0, 1) || e > 60) &&
            ((d.transparent = !0),
            (d.opacity = Math.max(50 / e + Object(o.h)(-0.3, 0.3), 0.1)));
          const p = new n.Mesh(l, d);
          if (
            ...
            this.rings.push(p),
            this.cont.add(p),
            e < 20 && r < 1.3 * Math.PI && Object(o.g)(0, 2))
          )
            try {
              this.genRing(
                Object(o.i)(this.colors),
                e + Object(o.h)(-1, 3),
                i + Object(o.h)(-2, 0),
                s + r,
                r + Object(o.h)(-0.5, 0.5),
                h + Object(o.h)(-3, 1),
                a
              );
            } catch (t) {}
        ...
        onInit() {
            ...
            Object(o.g)(0, 3)
              ? ((e =
                ...
                (t =
                  ...
                  Object(o.g)(0, e / 4) -
                  e / 50))
              : ((e = Object(o.h)(1, 3) * Object(o.h)(2, 4)),
                (t =
                  Object(o.h)(1, 2) *
                  Object(o.h)(1, 2) *
                  Object(o.h)(1.1, 1.5)));
            const i = 0.05 * Math.pow(2, Object(o.g)(0, 4));
            t < i && (t = i),
              this.genRing(
                Object(o.i)(this.colors),
                e,
                ...
                Object(o.h)(0, 1e3),
                Object(o.h)(1, 6),
                Object(o.h)(0, 50 / (e + 1) + 5) + 5 / t / (e + 0.5),
                0.25 *
                  Math.max(
                    -Object(o.h)(0.5, 2),
                    Object(o.h)(1, 50 - e / 2) - e / 2
                  )
              );
          }
          ...
          const s = new n.AmbientLight(16777215, 0.5);
          return (
            this.scene.add(s),
            (this.pointLight = new n.PointLight(16777215, 0.5)),
            this.pointLight.position.set(0, 150, 200),
            this.scene.add(this.pointLight),
            (this.spot = new n.SpotLight(16777215, 1)),
      ...
      r.initClass(), (e.default = s.a.register("RINGS", r));
    }
  });
});
