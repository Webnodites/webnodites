          ...
          <div class="col-12 col-md-8 col-lg-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="contact.html" class="nav-link cnt active">Contact</a></li>
              </ul>
            </nav>
          </div>
    ...
    <section class="site-blocks-cover overflow-hidden">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 col-12 contleft">
            <div>
              <div class="cntbox">
              ...
              <div class="cntbox">
                <h2 class="cnthead">Mobile No. </h2>
                <a href="tel:+918500792188" class="cnttext">+91 850 079 2188</a>
              </div>

              <div class="cntbox">
                <h2 class="cnthead">Connect With Us</h2>
                <a href="https://www.linkedin.com/in/webnodites/" target="_blank" class="cnttext">Linkedin</a><br>
                <a href="https://www.facebook.com/Webnodites-110977740623699" target="_blank" class="cnttext">Facebook</a><br>
                <a href="https://www.instagram.com/webnodites/" target="_blank" class="cnttext">Instagram</a>
                <br>
                <a href="https://twitter.com/webnodites" target="_blank" class="cnttext">Twitter</a>
                <br>
          ...
          <div class="contright">
            <div class="Rectangle-215">
              ...
              <div  class="Say-directly">
                <p align="center">Say directly</p>
              </div>
              <form action="contactmail.php" method="post" name="cform" onsubmit="validate();">

                <div class="form-group">
                  <input type="text" name="name" placeholder="Full Name" class="cntinput  only-alpha require form_field" required>
                </div>

                <div class="form-group">
                  <input type="text" name="email" placeholder="Email" class="cntinput  require form_field" required>
                </div>

                <div class="form-group row">
                  <div class="col-5">
                    <select name="countrycode" id="" class="cntinput" style="font-size: 18px;">
                  ...
                  <div class="col-7">
                    <input type="text" name="phone" class="cntinput  require form_field only-numeric" placeholder="Phone No." required>
                  </div>
              ...
              <div class="form-group">
                <input type="submit" name="submitbtn" placeholder="Submit" value="Submit" class="Submit">
              </div>
              ...
              <div class="mb-5">
                ...
                <div>
                  <ul class="list-unstyled sc">
                    <li>
                      <a href="mailto:webnodites@gmail.com"><img src="images/gmail.png">contact@webnodites.com</a>
                    </li>
                    <li>
